...
require (
	...
	github.com/onmetal/controller-utils v0.6.6-0.20221213084549-493ec9e030cc
...
replace (
	...
	go.opentelemetry.io/otel/semconv => go.opentelemetry.io/otel/semconv v0.20.0
