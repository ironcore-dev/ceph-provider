...
func TestHandler(t *testing.T) {
	...
	RunSpecs(t, "Event Recorder Suite")
}
...
var (
	...
	apiMetadata = api.Metadata{
		...
		Annotations: map[string]string{
			"ceph-provider.ironcore.dev/annotations": "{\"key1\":\"value1\", \"key2\":\"value2\"}",
			"ceph-provider.ironcore.dev/labels":      "{\"downward-api.volumepoollet.ironcore.dev/root-volume-namespace\":\"default\", \"downward-api.volumepoollet.ironcore.dev/root-volume-name\":\"volume1\"}",
		}}
